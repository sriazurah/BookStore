  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
       ...
       <a class="navbar-brand" href="#"><img src="images/hederr.png" style="width:150px; margin-top: -7px;"></a>
        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko buku murah.<h1 style="color:#f97b61;">Ajuu<b>BOOK.pol</b></h1></h2>
...
Cara Pesan
      ...
      <div class="row" style="margin:20px;">
		<p><h3><b>1. Pembayaran dilakukan dalam jangka waktu 1x24 jam setelah melakukan pemesanan.<br>
          ...
          <br>
		<p style="color:#0000ff;">Sri Azurah,
		BNI Syariah Marendal City,
		No Rek 00112233</p>
		<br>
   ...
   <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <li>Marendal, Kongsi</li>
          <li>Harjosari, Medan</li>
